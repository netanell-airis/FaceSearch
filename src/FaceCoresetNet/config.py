...
def get_args():
    ...
    parent_parser.add_argument('--data_root', type=str, default='datasets')
    parent_parser.add_argument('--train_data_path', type=str, default='webface4m_subset_images')
    ...
    parent_parser.add_argument('--prefix', type=str, default='webface')
    ...
    parent_parser.add_argument('--strategy', type=str, default='ddp_find_unused_parameters_true')
    ...
    parent_parser.add_argument('--num_workers', default=0, type=int)
...
def add_task_arguments(parser):
    parser.add_argument('--arch', default='ir_101')
