...
from FaceCoresetNet import config
...
def prepare_face_for_recognition(fname, landmarks):
    img = Image.open(fname)
    warped_face = warp_and_crop_face(np.array(img), landmarks, REFERENCE_FACIAL_POINTS, crop_size=(112, 112))
    aligned_face = PIL.Image.fromarray(warped_face)
    return aligned_face
